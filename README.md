...
[![Maintained by next-linux.systems](https://img.shields.io/badge/maintained%20by-next-linux.systems-blueviolet)](https://next-linux.systems/?utm_source=github&utm_medium=organic_oss&utm_campaign=secure-repo)
[![Go Report Card](https://goreportcard.com/badge/github.com/nextlinux/secure-repo)](https://goreportcard.com/report/github.com/nextlinux/secure-repo)
[![codecov](https://codecov.io/gh/nextlinux/secure-repo/branch/main/graph/badge.svg?token=02ONA6U92A)](https://codecov.io/gh/nextlinux/secure-repo)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/nextlinux/secure-repo/badge)](https://api.securityscorecards.dev/projects/github.com/nextlinux/secure-repo)
...
- Secure-Repo stores the permissions needed by different GitHub Actions in a [knowledge base](<(https://github.com/nextlinux/secure-repo/tree/main/knowledge-base/actions)>)
...
- If you are the owner of a GitHub Action, please [contribute to the knowledge base](https://github.com/nextlinux/secure-repo/blob/main/knowledge-base/actions/README.md)

### 2. Add Harden-Runner GitHub Action to each job

#### Why is this needed?

[Harden-Runner GitHub Action](https://github.com/nextlinux/harden-runner) installs a security agent on the Github-hosted runner to prevent exfiltration of credentials, monitor the build process, and detect compromised dependencies.
...
Secure-Repo updates the YAML file and adds [Harden-Runner GitHub Action](https://github.com/nextlinux/harden-runner) as the first step to each job.
...
Secure-Repo has a [workflow-templates](https://github.com/nextlinux/secure-repo/tree/main/workflow-templates) folder. This folder has the default dependency review workflow, which gets added as part of the pull request.
...
Secure-Repo has a [workflow-templates](https://github.com/nextlinux/secure-repo/tree/main/workflow-templates) folder. This folder has the default Scorecard workflow, which gets added as part of the pull request.

## Quickstart

### Hosted Instance: [app.next-linux.systems/securerepo](https://app.next-linux.systems/securerepo)

To secure your GitHub repo using a pull request:

- Go to https://app.next-linux.systems/securerepo and enter your public GitHub repository
...
- Follow the remediation tip that points to https://app.next-linux.systems
