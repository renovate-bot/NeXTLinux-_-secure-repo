...
const (
	...
	nextlinuxowner = "nextlinux"
	branch         = "main"
	workflowFile   = "kbanalysis.yml"
	nextlinuxrepo  = "secure-repo"
	allIssues      = "all"
	openIssues     = "open"
)
...
func dispatchWorkflow(action string) error {
	...
	_, err := client.Actions.CreateWorkflowDispatchEventByFileName(context.Background(), nextlinuxowner, nextlinuxrepo, workflowFile, eventRequest)
