...
import (
	...
	"github.com/nextlinux/secure-repo/remediation/workflow/hardenrunner"
	"github.com/nextlinux/secure-repo/remediation/workflow/permissions"
	"github.com/nextlinux/secure-repo/remediation/workflow/pin"
)

const (
	HardenRunnerActionPathWithTag = "nextlinux/harden-runner@v2"
	HardenRunnerActionPath        = "nextlinux/harden-runner"
