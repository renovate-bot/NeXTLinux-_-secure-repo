...
func TestSecureWorkflow(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://api.github.com/repos/nextlinux/harden-runner/commits/v2",
		httpmock.NewStringResponder(200, `ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5`))

	httpmock.RegisterResponder("GET", "https://api.github.com/repos/nextlinux/harden-runner/git/matching-refs/tags/v2.",
		httpmock.NewStringResponder(200,
			`[
				{
				  "ref": "refs/tags/v2.0.0",
				  "node_id": "REF_kwDOGSuXyrByZWZzL3RhZ3MvdjIuMC4w",
				  "url": "https://api.github.com/repos/nextlinux/harden-runner/git/refs/tags/v2.0.0",
				  "object": {
					"sha": "ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5",
					"type": "commit",
					"url": "https://api.github.com/repos/nextlinux/harden-runner/git/commits/ebacdc22ef6c2cfb85ee5ded8f2e640f4c776dd5"
				  }
				}
			  ]`),
	)
